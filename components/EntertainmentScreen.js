      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.transactionsContainer}>
          ...
          <View style={styles.transactionBox}>
            <MaterialCommunityIcons name="movie" size={24} color={colors.lettersAndIcons} />
            <View style={styles.transactionDetails}>
              <Text style={styles.transactionTitle}>Movie</Text>
          ...
          <View style={styles.transactionBox}>
            ...
            <View style={styles.transactionDetails}>
              ...
              <Text style={styles.transactionAmount}>-₹350.00</Text>
            </View>
          </View>
        </View>
      </ScrollView>
